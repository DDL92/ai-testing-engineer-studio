...
- Manual tracking note: update local contact review only after manual action. Suggested command: `npm run contact:review -- --id pushpress`
...
- Follow-up 2 timing: 7-10 business days later.
- Stop condition: stop after 2 follow-ups unless they respond, or stop immediately if not relevant/not interested.
- Manual tracking note: update local contact review only after manual action. Suggested command: `npm run contact:review -- --id teamup`
...
- Follow-up 2 timing: 7-10 business days later.
- Stop condition: stop after 2 follow-ups unless they respond, or stop immediately if not relevant/not interested.
- Manual tracking note: update local contact review only after manual action. Suggested command: `npm run contact:review -- --id wodify`
...
- Follow-up 2 timing: 7-10 business days later.
- Stop condition: stop after 2 follow-ups unless they respond, or stop immediately if not relevant/not interested.
- Manual tracking note: update local contact review only after manual action. Suggested command: `npm run contact:review -- --id abc-glofox`
...
- Follow-up 2 timing: 7-10 business days later.
- Stop condition: stop after 2 follow-ups unless they respond, or stop immediately if not relevant/not interested.
- Manual tracking note: update local contact review only after manual action. Suggested command: `npm run contact:review -- --id bookee`
