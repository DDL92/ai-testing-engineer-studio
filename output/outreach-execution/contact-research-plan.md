...
- Target roles: Founder, CTO, VP Engineering, Head of Engineering, Product Manager, QA Manager, Operations Lead
...
- Recommended contact channel: linkedin
- Next command after contact is found: `npm run contact:review -- --id pushpress`
...
- What to verify: company match, current role, relevance to product/engineering/operations/QA, public source quality.
- What not to do: do not scrape, export, enrich, guess names, guess emails, or use private data.
- Recommended contact channel: linkedin or website-contact-form
- Next command after contact is found: `npm run contact:review -- --id teamup`
...
- What not to do: do not scrape, export, enrich, guess names, guess emails, or use private data.
- Recommended contact channel: linkedin or website-contact-form
- Next command after contact is found: `npm run contact:review -- --id wodify`
...
- What not to do: do not scrape, export, enrich, guess names, guess emails, or use private data.
- Recommended contact channel: linkedin or website-contact-form
- Next command after contact is found: `npm run contact:review -- --id abc-glofox`
...
- What not to do: do not scrape, export, enrich, guess names, guess emails, or use private data.
- Recommended contact channel: linkedin or website-contact-form
- Next command after contact is found: `npm run contact:review -- --id bookee`
