...
- Website: https://acme-saas-demo.example
- Industry: SaaS
- Score: 6/10
...
- Local notes: Demo manually researched SaaS lead with onboarding and regression testing opportunity
- Local pain point notes: signup/onboarding coverage, regression testing opportunity.
...
- Recommended offer: qa-audit
- Reasoning should be reviewed manually. Local scoring reasons: +1.5 Has a website to review; +1.25 Strong QA-fit industry: saas; +3 Relevant QA pain points: signup, onboarding, regression
...
- npm run audit:site -- --url https://acme-saas-demo.example
